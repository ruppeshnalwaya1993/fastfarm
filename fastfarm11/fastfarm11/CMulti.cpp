...
bool CMulti::OnInit()
{
	...
	if(CArea::AreaControl.OnLoad("../maps/1.area", ren) == false) {return false;}
	if(CPlayersM::playerControl.OnLoad("../tilesets/pl1.png","../tilesets/pl2.png",82,82,1,ren)==false) return false;
...
void CMulti::OnLoop(){
	...
	else ratioEnt.X= (FARM_j+FARM_WIDTH/2)*TILE_SIZE - ratioEnt.getCenter().first;
}
